...
public class SoundManager {
	...
	public void addSound(int soundId) {
		mSoundPoolMap.add(
		/*
		 * Carrega e obtém o id do som no pool O segundo parâmetro o id do
		 * recurso E o terceiro não serve pra nada :) , Mas na documentação diz
		 * pra colocar 1
		 */
	...
	public void playSound(int index) {
		/*
		 * O AudioManager é usado aqui pra obter o valor atual do volume do
		 * aparelho para não tocar o som nem baixo nem alto demais. A divisão
		 * que é feita aqui é pq o método requer um valor entre 0.0 e 1.0.
		 */
		...
		/*
		 * playId, armazena o id da requisição do som a ser tocado. Ele é usado
		 * para parar um determinado som a qualquer momento.
		 */
